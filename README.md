...
1. **Topic C3:** Data handling #3 (structures, reading and writing files, processing CSV documents, using functions `qsort()` and `bsearch()`, representing data structures).
