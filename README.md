...
1. [**Topic B2:** Data structures and built-in functions #2 (strings, dynamic memory allocation).](./week-06/README.md)
1. [**Topic B3:** Data structures and built-in functions #3 (multidimensional arrays, consuming command-line arguments).](./week-07/README.md)
1. [**Topic C1:** Data handling #1 (structures, reading and writing files, processing CSV documents, using functions `qsort()` and `bsearch()`, representing data structures).](./week-08/README.md)
1. [**Topic C2:** Data handling #2 (structures, reading and writing files, processing CSV documents, using functions `qsort()` and `bsearch()`, representing data structures).](./week-09/README.md)
1. [**Topic C3:** Data handling #3 (structures, reading and writing files, processing CSV documents, using functions `qsort()` and `bsearch()`, representing data structures).](./week-10/README.md)
